    ...
    <div class="container mt-5">
        <div class="card mb-3">
            <div class="card-header">
                <h3 aria-label="Editar doação de roupas e calçados">Editar Doação de Roupas e Calçados</h3>
            </div>
            <div class="card-body mb-0">
                ...
                <div class="container">
                    ...
                    <select v-model="model.campaignId" class="form-control selectpicker show-tick" id="campaignId"
                        title="Selecione uma campanha..." disabled>
                    ...
                    <div class="row g-3">
                        <div class="col">
                            <select v-model="model.childId" data-live-search="true" class="form-control selectpicker show-tick"
                                id="childId" title="Selecione uma criança..." disabled>
...
export default {
    ...
    methods: {
        getChildContribution() {
            ...
            const url = "/api/child-contribution/" + this.$route.params.id;
        ...
        validateForm() {
            ...
            if (this.model.wasDelivered === false || this.model.isToyDelivered === null) {
                this.model.acceptance = null;
            }
            if ((this.model.wasDelivered &&  this.model.isToyDelivered) && this.model.acceptance !== null) {
